...
function loadImbaAdminModule(moduleName, moduleDo, payLoad){
    ...
    $.post(ajaxEntry, {
        ...
        $("#imbaContentDialog").dialog({
            title: "<img src='Images/user-home.png' style='cursor: pointer;' width='16' height='16' onclick='javascript:loadImbaAdminDefaultModule();' verticalAlign='bottom' /> IMBAdmin " + response
        });
    });
