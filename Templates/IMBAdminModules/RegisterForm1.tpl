...
<br>
<h3>Habe ich vielleicht schon eine OpenID und wie sehen die aus?</h3><br>
<div><h4>Google</h4>
...
<br>
<div><h4>OOM</h4>
OOM OpenIDs sind von unserem eigenen OpenID-Provider, wer sich hiere eine OpenID macht hat den<br>
